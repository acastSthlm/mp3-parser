...
(function (globalObject, createModule) {
    ...
    var id3v2TagFrameNames = {
        ...
        readFrameContentIpls = function (view, offset, length) {
            ...
            while (offsetBeg < offset + length) {
                ...
                if(offsetNextStrTrm === -1) {
                  offsetNextStrTrm = length + offset;
                }
        ...
        // * Start time:    8 octets specifying the start of the chapter in milliseconds
        // * End time:      8 octets specifying the end of the chapter in milliseconds
        // * Start offset:  8 octets specifying the start of the chapter in bytes
        // * End offset:    8 octets specifying the end of the chapter in bytes
